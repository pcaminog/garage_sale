...
<div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
	<form>
		...
		<div>
			<input
				type="submit"
                class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-green-600 dark:focus:ring-green-800 mb-4"
